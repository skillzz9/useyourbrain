# USE YOUR BRAIN! TAKE BACK YOUR INTELLIGENCE!!
...
Useyourbrain is an application that forces proper AI use when learning. Its a simple concept that not only exposes the reliance on AI tools to learn, but also forces you to use the tools better. It actually makes you, i dont know, USE YOUR BRAIN!?

## How it works
You start a deep learning session. You set a limit to how many prompts you will use during that time. And you get deep. 

A paired extension will log and save all the prompts you used in that session locally on your computer. Nothing is sent to the cloud so you can ensure your prompts are safe. If you go over your set limit of prompts, you will be blocked out of the AI tool in the browser until the time is up. This way your not spamming the AI tool with nonsense and asking for answers. After the session is done, Useyourbrain will analyse all the prompts you used and give you a learning score based on how many times you asked for the answer or asked some nonsense that disrupts the deep learning process. Now you can see how long you can go without relying on AI to code, do maths, write an English introduction, or even just sit alone with your thoughts and think abotu a situaton without asking AI for advice ALL THE TIME. 
